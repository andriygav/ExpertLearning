...
На рис.~\ref{intro:fig2} показан пример кривых второго порядка, а также экспертная информация о кривых. Рис.~\ref{intro:fig2:exp1} показывает экспертную информацию первого эксперта. При использовании данной информации первая кривая аппрокимируется линейной моделью, а вторая кривая является шумом. Рис.~\ref{intro:fig2:exp2} показывает экспертную информация второго эксперта. При использовании данной информации вторая кривая аппрокимируется линейной моделью, а первая кривая является шумом. 
