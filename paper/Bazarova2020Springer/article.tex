...
The papers~\cite{Han2020} \cite{Akhtar2018} show that deep learning networks are sensitive even to small noise in the data, which is due to their uninterpretability.
...
Estabrooks A, Japkowicz N (2009) Recognition of Persian handwritten digits using characterization loci and mixture of experts. J. Digital Content Technol. Appl. 42--46

\bibitem{Estabrooks2001}
Ebrahimpour R, M. Moradian R, Esmkhani A, Jafarlou F (2009) A mixture-of-experts framework for text classification. In Proc. Workshop Comput. Natural Lang. Learn., Assoc. Comput. Linguist. 1--8
